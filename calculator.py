...
def add_to_calculation(symbol):
    ...
    root_result.delete(1.0 , "end")
    root_result.insert(1.0 , calculation)
...
root_result = tk.Text(root , height=2 , width=23 , font=("Arial",24))
root_result.grid(columnspan=5)
...
btn_multi = tk.Button(root , text="*" , command=lambda : add_to_calculation("*"), width=5 , font=("Arial",15))
...
btn_clear.grid(row=7 , column=3 , columnspan=2)
btn_equal = tk.Button(root , text="=" , command=lambda :evaluate_calculation(1), width=12 , font=("Arial",15))
